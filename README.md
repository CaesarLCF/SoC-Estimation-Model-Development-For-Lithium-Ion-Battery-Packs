...
a) Parameters: Terminal Voltage, Open-Circuit Voltage, Load Current, Cell Temperature, and SoC.
b) Battery Types: Li-FP, Li-NMC, Li-NCA, Li-PO, and Li-Ion (Graphite).
...
5) Evaluated and Benchmarked to Identify the Most Effective SoC Estimation Model:
