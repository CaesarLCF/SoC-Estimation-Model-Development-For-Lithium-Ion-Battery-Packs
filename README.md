...
The research will provide a detailed comparison of these SoC estimation methods based on coefficient of determination (R2), mean absolute error (MAE), and root mean square error (RMSE), determining the necessity for implementing data-driven models and the best-performing data-driven model for LIB and LiBat systems in the AMR sector. To achieve this, the following objectives must be completed:
